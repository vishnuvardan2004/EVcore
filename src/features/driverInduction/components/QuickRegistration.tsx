  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: `${tempPilot.fullName} (${tempPilot.tempId}) can now take up to ${tempPilot.allowedRides} rides.`,
      });
      ...
      toast({
        ...
        description: 'There was an error registering the temporary pilot. Please try again.',
        variant: 'destructive'
      });
    } finally {
